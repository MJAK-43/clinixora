...
export function registerReceptionRoomsPage() {
    window.Alpine.data('receptionRoomsPage', (config) => ({
        ...
        applySearch(detail) {
            ...
            delete this.query.reception_rooms_page;
            this.refreshTable();
        },

        async refreshTable() {
            const target = document.getElementById('reception-rooms-table-body');
            if (!target) {
                return;
            }
            ...
            try {
                ...
                console.error('Recherche salles d\'accueil :', error);
            } finally {
                this.loading = false;
