<aside class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm" aria-labelledby="operating-blocks-filters-heading">
    <h2 id="operating-blocks-filters-heading" class="text-sm font-semibold text-slate-900">Filtres</h2>

    <form method="GET" action="{{ route('operating_blocks.index') }}" class="mt-4 space-y-4">
        <div>
        ...
        <div class="flex gap-2 pt-2">
            <a
                href="{{ route('operating_blocks.index', ['per_page' => $perPage]) }}"
